...
function mnEquipXls(rec){
  if(typeof JSZip==='undefined'){toast('압축 모듈 없음 — 새로고침(Ctrl+Shift+R)');return;}
  toast('설비사진 엑셀 생성 중...');
  JSZip.loadAsync(MN_XLS_TPL,{base64:true}).then(function(zip){
...
function mnOpenForm(rec){
  ...
  var inner='<div style="background:#fff;'+(host?'width:100%;height:100%;border-radius:0':(mob?'width:100vw;height:100dvh;border-radius:0':'border-radius:14px;width:min(96vw,540px);max-height:95dvh'))+';display:flex;flex-direction:column;overflow:hidden">'
    +'<div style="padding:10px 14px;border-bottom:1px solid #eee;display:flex;align-items:center;flex:none"><b style="flex:1;font-size:15px">맨홀 조사야장</b><button id="mnDxfBtn" style="border:1px solid #c0392b;background:#fdeaea;color:#c0392b;border-radius:8px;padding:6px 10px;margin-right:6px;cursor:pointer;font-weight:700;font-size:12.5px">📐 맨홀도DXF</button><button id="mnEqXls" style="border:1px solid #1d9e75;background:#e1f5ee;color:#0f6e56;border-radius:8px;padding:6px 10px;margin-right:6px;cursor:pointer;font-weight:700;font-size:12.5px">📄 설비사진엑셀</button><button id="mnPhotoDl" style="border:1px solid #2471a3;background:#eef6fc;color:#2471a3;border-radius:8px;padding:6px 10px;margin-right:8px;cursor:pointer;font-weight:700;font-size:12.5px">📥 맨홀사진다운</button><button id="mnFClose" style="border:none;background:#f2f2f2;border-radius:8px;padding:6px 12px;cursor:pointer">닫기</button></div>'
